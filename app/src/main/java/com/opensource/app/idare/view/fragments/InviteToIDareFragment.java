 ...
 */
public class InviteToIDareFragment extends BaseFragment {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container, Bundle savedInstanceState) {
        ...
        mMainActivity.getSupportActionBar().setTitle(mMainActivity.getStringArray(R.array.arr_nav_titles)[2]);
    ...
    int getFragmentLayoutResourceId() {
        return R.layout.fragment_invite_to_idare;
    }
